...
export const ITINERARIES: Itinerary[] = [
  ...
  {
    slug: "kashmir-grand-circuit-9d",
    title: "Kashmir: The Grand Saffron & Alpine Circuit — 9 days",
    countrySlug: "india",
    region: "Kashmir, India",
    flag: "🇮🇳",
    days: 9,
    bestMonths: [4, 5, 6, 9, 10],
    difficulty: "moderate",
    terrains: ["mountains", "lakes", "culture", "snow"],
    blurb: "The ultimate Kashmir experience. From the houseboats of Srinagar to the high meadows of Pahalgam and the snow peaks of Gulmarg.",
    totalUsd: 880,
    highlights: ["Dal Lake Houseboat Stay", "Gondola Phase 2 in Gulmarg", "Baisaran Meadow Hike", "Old City Wazwan Feast"],
    category: "Classic",
    tags: ["Lakes", "Snow", "Heritage", "Photography"],
    plan: [
      { day: 1, title: "Dal Lake Immersion", base: "Srinagar", stayUsd: 45,
        stops: [
          { place: "SXR Airport → Dal Lake", activity: "Transfer to Houseboat", hours: 1, km: 15, mode: "car", costUsd: 12, lat: 34.0837, lng: 74.7973 },
          { place: "Dal Lake", activity: "Sunset Shikara ride", hours: 2, km: 5, mode: "boat", costUsd: 10, lat: 34.0900, lng: 74.8300 },
        ] },
      { day: 2, title: "Mughal Heritage", base: "Srinagar", stayUsd: 45,
        stops: [
          { place: "Nishat & Shalimar", activity: "Royal garden strolls", hours: 3, km: 12, mode: "car", costUsd: 15, lat: 34.1486, lng: 74.8731 },
          { place: "Pari Mahal", activity: "Viewpoint overlooking the lake", hours: 1.5, km: 8, mode: "car", costUsd: 5, lat: 34.0722, lng: 74.8450 },
        ] },
      { day: 3, title: "Old City & Souks", base: "Srinagar", stayUsd: 45,
        stops: [
          { place: "Jamia Masjid", activity: "Indo-Saracenic architecture", hours: 2, km: 10, mode: "car", costUsd: 10, lat: 34.0900, lng: 74.8100 },
          { place: "Hazratbal Shrine", activity: "White marble shrine by the lake", hours: 1.5, km: 5, mode: "car", costUsd: 5 },
        ] },
      { day: 4, title: "Gulmarg Alpine Entry", base: "Gulmarg", stayUsd: 95,
        stops: [
          { place: "Srinagar → Gulmarg", activity: "Scenic mountain climb", hours: 2, km: 50, mode: "car", costUsd: 35, lat: 34.0484, lng: 74.3805 },
          { place: "Gulmarg Meadows", activity: "High-altitude walk", hours: 2, km: 3, mode: "walk", costUsd: 0 },
        ] },
      { day: 5, title: "The High Peaks", base: "Gulmarg", stayUsd: 95,
        stops: [
          { place: "Gondola Phase 1 & 2", activity: "Ride to 14,000ft (Apharwat Peak)", hours: 4, km: 5, mode: "walk", costUsd: 45, lat: 34.0500, lng: 74.3700 },
          { place: "St. Mary's Church", activity: "Victorian architecture in the wild", hours: 1, km: 2, mode: "walk", costUsd: 0 },
        ] },
      { day: 6, title: "Drive to the Valley of Shepherds", base: "Pahalgam", stayUsd: 65,
        stops: [
          { place: "Gulmarg → Pahalgam", activity: "Long cross-country drive", hours: 5, km: 140, mode: "car", costUsd: 75, lat: 34.0100, lng: 75.3100 },
          { place: "Lidder River", activity: "Evening riverside tea", hours: 1, km: 2, mode: "walk", costUsd: 5 },
        ] },
      { day: 7, title: "Betaab & Aru Valleys", base: "Pahalgam", stayUsd: 65,
        stops: [
          { place: "Betaab Valley", activity: "Iconic cinematic meadows", hours: 2, km: 15, mode: "car", costUsd: 15, lat: 34.0200, lng: 75.3500 },
          { place: "Aru Valley", activity: "Eco-tourism village stroll", hours: 3, km: 12, mode: "car", costUsd: 15, lat: 34.0800, lng: 75.2500 },
        ] },
      { day: 8, title: "Mini Switzerland", base: "Pahalgam", stayUsd: 65,
        stops: [
          { place: "Baisaran Meadow", activity: "Pony ride or trek to high meadow", hours: 4, km: 8, mode: "walk", costUsd: 25 },
          { place: "Dabiyan", activity: "Higher viewpoint into the mountains", hours: 2, km: 4, mode: "walk", costUsd: 5 },
        ] },
      { day: 9, title: "Final Departure", base: "SXR", stayUsd: 0,
        stops: [
          { place: "Pahalgam → SXR Airport", activity: "Transfer and final shopping", hours: 3.5, km: 95, mode: "car", costUsd: 55 },
        ] },
    ],
  },
  {
    slug: "india-hampi-3d",
    title: "Hampi: Boulder-strewn Ruins — 3 days",
    countrySlug: "india",
    ...
    bestMonths: [11, 12, 1, 2],
    difficulty: "moderate",
    terrains: ["history", "rivers", "boulders"],
    blurb: "The fallen Vijayanagara empire. A surreal landscape of granite boulders and 14th-century temples.",
    totalUsd: 220,
    highlights: ["Vittala Temple Stone Chariot", "Sunrise at Matanga Hill", "Coracle boat ride"],
    category: "Discovery",
    tags: ["Archaeology", "Sunset", "River"],
    plan: [
      { day: 1, title: "Temple Core", base: "Hampi", stayUsd: 35,
        stops: [
          { place: "Virupaksha Temple", activity: "Active worship & gopuram view", hours: 2, km: 1, mode: "walk", costUsd: 5 },
          { place: "Hemakuta Hill", activity: "Sunset over the ruins", hours: 2, km: 1, mode: "walk", costUsd: 0 },
        ] },
      { day: 2, title: "The Royal Enclosure", base: "Hampi", stayUsd: 35,
        stops: [
          { place: "Vittala Temple", activity: "Stone Chariot & musical pillars", hours: 3, km: 5, mode: "bike", costUsd: 10 },
          { place: "Lotus Mahal", activity: "Royal Zenana architecture", hours: 2, km: 3, mode: "bike", costUsd: 5 },
        ] },
      { day: 3, title: "Anegundi (Hipside)", base: "Hampi", stayUsd: 0,
        stops: [
          { place: "Tungabhadra River", activity: "Coracle boat crossing", hours: 1, km: 0.5, mode: "boat", costUsd: 8 },
          { place: "Anjanadri Hill", activity: "Monkey Temple (Birthplace of Hanuman)", hours: 3, km: 10, mode: "bike", costUsd: 5 },
        ] },
    ],
  },
  {
    slug: "india-varanasi-3d",
    title: "Varanasi: The Spiritual Pulse — 3 days",
    countrySlug: "india",
    ...
    difficulty: "hard",
    terrains: ["culture", "history", "rivers"],
    blurb: "One of the oldest living cities. A dense, spiritual journey along the Ganges.",
    totalUsd: 180,
    highlights: ["Ganga Aarti at Dashashwamedh Ghat", "Sunrise boat ride", "Sarnath excavation"],
    category: "Hidden Gem",
    tags: ["Spiritual", "Photography", "Chaos"],
    plan: [
      { day: 1, title: "The Ghats at Night", base: "Varanasi", stayUsd: 25,
        stops: [
          { place: "Dashashwamedh Ghat", activity: "Evening Ganga Aarti ceremony", hours: 2, km: 5, mode: "walk", costUsd: 0 },
          { place: "Godowlia", activity: "Street food exploration (Chaats & Lassi)", hours: 2, km: 1, mode: "walk", costUsd: 10 },
        ] },
      { day: 2, title: "Sunrise & Silk", base: "Varanasi", stayUsd: 25,
        stops: [
          { place: "Assi Ghat → Manikarnika", activity: "Sunrise boat ride on the Ganges", hours: 2, km: 4, mode: "boat", costUsd: 15 },
          { place: "Silk Weaving Village", activity: "Traditional Banarasi silk weaving", hours: 3, km: 10, mode: "car", costUsd: 10 },
        ] },
      { day: 3, title: "Sarnath Discovery", base: "Varanasi", stayUsd: 0,
        stops: [
          { place: "Sarnath", activity: "Dhamek Stupa & Archaeological Museum", hours: 4, km: 12, mode: "car", costUsd: 15 },
        ] },
    ],
  },
  {
    slug: "japan-tokyo-loop-3d",
    title: "Tokyo: The Cyber-City Loop — 3 days",
    countrySlug: "japan",
    region: "Tokyo, Japan",
    flag: "🇯🇵",
    days: 3,
    ...
    difficulty: "easy",
    terrains: ["city", "tech", "food"],
    blurb: "Tokyo in overdrive. From ancient shrines to neon intersections and Michelin-star ramen.",
    totalUsd: 650,
    highlights: ["Shibuya Crossing", "teamLab Borderless", "Tsukiji Outer Market"],
    category: "Base Camp",
    tags: ["City", "Tech", "Foodie"],
    plan: [
      { day: 1, title: "Neon & Tradition", base: "Tokyo", stayUsd: 120,
        stops: [
          { place: "Shibuya", activity: "Scramble crossing & Hachiko", hours: 2, km: 2, mode: "walk", costUsd: 0 },
          { place: "Harajuku", activity: "Takeshita Street & Meiji Shrine", hours: 3, km: 3, mode: "walk", costUsd: 15 },
        ] },
      { day: 2, title: "Art & Tech", base: "Tokyo", stayUsd: 120,
        stops: [
          { place: "teamLab Borderless", activity: "Immersive digital art", hours: 3, km: 8, mode: "train", costUsd: 40 },
          { place: "Akihabara", activity: "Electric Town & Retro Gaming", hours: 3, km: 5, mode: "train", costUsd: 25 },
        ] },
      { day: 3, title: "The Market Beat", base: "Tokyo", stayUsd: 0,
        stops: [
          { place: "Tsukiji Outer Market", activity: "Sushi breakfast", hours: 3, km: 4, mode: "train", costUsd: 55 },
          { place: "Ginza", activity: "Department store basement (Depachika)", hours: 2, km: 2, mode: "walk", costUsd: 30 },
        ] },
    ],
  },
  ...
  },
  {
    ...
    plan: [
      ...
      { day: 6, title: "North Coast → Akureyri", base: "Akureyri", stayUsd: 105,
        stops: [
          { place: "Goðafoss", activity: "Waterfall of the Gods", hours: 1, km: 40, mode: "car", costUsd: 0, lat: 65.6828, lng: -17.5502 },
          { place: "Húsavík", activity: "Whale watching in the bay", hours: 4, km: 45, mode: "car", costUsd: 90, lat: 66.0449, lng: -17.3389 },
        ] },
      { day: 7, title: "Akureyri → Westfjords", base: "Isafjordur", stayUsd: 115,
        stops: [
          { place: "Driving the North Cape", activity: "Most remote roads in Iceland", hours: 7, km: 350, mode: "car", costUsd: 60 },
          { place: "Dynjandi", activity: "Thunderous mountain waterfall", hours: 1.5, km: 20, mode: "car", costUsd: 0, lat: 65.7328, lng: -23.1997 },
        ] },
      { day: 8, title: "Snæfellsnes Peninsula", base: "Grundarfjörður", stayUsd: 110,
        stops: [
          { place: "Kirkjufell", activity: "Iceland's most photographed mountain", hours: 1.5, km: 120, mode: "car", costUsd: 0, lat: 64.9417, lng: -23.3069 },
          { place: "Arnarstapi", activity: "Coastal walk & stone bridge", hours: 2, km: 40, mode: "car", costUsd: 0, lat: 64.7667, lng: -23.6167 },
        ] },
      { day: 9, title: "Reykjavik Departure", base: "Reykjavik", stayUsd: 0,
        stops: [
          { place: "Grundarfjörður → KEF", activity: "Final drive to airport", hours: 3, km: 230, mode: "car", costUsd: 45 },
        ] },
    ]
  },
  {
    ...
    plan: [
      ...
      { day: 3, title: "Ha Long → Ninh Binh", base: "Ninh Binh", stayUsd: 28,
        stops: [
          { place: "Ha Long → Tam Coc", activity: "Transfer to 'Ha Long on Land'", hours: 3.5, km: 180, mode: "bus", costUsd: 20, lat: 20.2186, lng: 105.9419 },
          { place: "Trang An Boat Trip", activity: "UNESCO karst cave rowing", hours: 3, km: 5, mode: "boat", costUsd: 15 },
        ] },
      { day: 4, title: "Ninh Binh → Hue (Sleeper)", base: "Hue", stayUsd: 35,
        stops: [
          { place: "Hang Mua", activity: "500-step climb for valley view", hours: 2, km: 5, mode: "bike", costUsd: 5 },
          { place: "Ninh Binh → Hue", activity: "Overnight SE train (Sleeper)", hours: 12, km: 580, mode: "train", costUsd: 45 },
        ] },
      { day: 5, title: "Hue Imperial City", base: "Hue", stayUsd: 25,
        stops: [
          { place: "Imperial Citadel", activity: "Citadel exploration", hours: 3, km: 2, mode: "walk", costUsd: 10, lat: 16.4678, lng: 107.5788 },
          { place: "Perfume River", activity: "Dragon boat to Thien Mu Pagoda", hours: 2, km: 5, mode: "boat", costUsd: 8 },
        ] },
      { day: 6, title: "Hue → Hoi An via Hai Van Pass", base: "Hoi An", stayUsd: 35,
        stops: [
          { place: "Hai Van Pass", activity: "Top Gear's favourite road", hours: 4, km: 130, mode: "car", costUsd: 35, lat: 16.1889, lng: 108.1311 },
          { place: "Hoi An Ancient Town", activity: "Lantern walk & custom tailoring", hours: 3, km: 1, mode: "walk", costUsd: 15 },
        ] },
      { day: 7, title: "Hoi An → Da Nang → HCMC", base: "Ho Chi Minh City", stayUsd: 40,
        stops: [
          { place: "Da Nang airport → HCMC", activity: "Domestic flight south", hours: 1.5, km: 630, mode: "flight", costUsd: 55 },
          { place: "Ben Thanh Market", activity: "Street food dinner", hours: 2, km: 2, mode: "walk", costUsd: 15 },
        ] },
    ]
  },
  {
  ...
  {
    slug: "japan-hokkaido-powder-7d",
    title: "Japan: Deep Hokkaido Powder — 7 days",
    countrySlug: "japan",
    ...
    bestMonths: [1, 2, 12],
    difficulty: "moderate",
    terrains: ["snow", "mountains", "food", "wellness"],
    blurb: "Skip Tokyo, fly straight to the powder capital. Niseko back-country, Sapporo ramen, and Otaru glassworks.",
    totalUsd: 1450,
    highlights: ["Niseko Hirafu powder runs", "Sapporo Beer Museum", "Otaru Canal lights", "Jozankei onsen forest"],
    category: "Road Trip",
    tags: ["Skiing", "Winter", "Seafood"],
    plan: [
      { day: 1, title: "Sapporo Arrival", base: "Sapporo", stayUsd: 85,
        stops: [
          { place: "CTS airport → Sapporo", activity: "Rapid Airport train", hours: 1, km: 45, mode: "train", costUsd: 15 },
          { place: "Susukino", activity: "Ramen Alley (Ganso Sapporo Ramen Yokocho)", hours: 2, km: 1, mode: "walk", costUsd: 22 },
        ] },
      { day: 2, title: "Sapporo → Niseko", base: "Niseko", stayUsd: 150,
        stops: [
          { place: "Sapporo → Niseko", activity: "White Liner shuttle bus", hours: 2.5, km: 110, mode: "bus", costUsd: 45 },
          { place: "Grand Hirafu", activity: "First tracks on legendary JAPOW", hours: 4, km: 5, mode: "bus", costUsd: 65 },
        ] },
      { day: 3, title: "Niseko Back-country", base: "Niseko", stayUsd: 150,
        stops: [
          { place: "Annupuri", activity: "Guided back-country gate tour", hours: 6, km: 10, mode: "car", costUsd: 120 },
          { place: "Kiranoyu Onsen", activity: "Recovery bath in the snow", hours: 2, km: 12, mode: "car", costUsd: 15 },
        ] },
      { day: 4, title: "Otaru Day Trip", base: "Sapporo", stayUsd: 85,
        stops: [
          { place: "Niseko → Otaru", activity: "Scenic JR Hakodate line", hours: 2, km: 75, mode: "train", costUsd: 25 },
          { place: "Otaru Canal", activity: "Glass blowing & fresh sushi", hours: 4, km: 2, mode: "walk", costUsd: 55 },
        ] },
      { day: 5, title: "Sapporo Highlights", base: "Sapporo", stayUsd: 85,
        stops: [
          { place: "Sapporo Beer Museum", activity: "Hokkaido heritage tasting", hours: 2, km: 4, mode: "car", costUsd: 12 },
          { place: "Mt. Moiwa", activity: "Ropeway for night view (Top 3 Japan)", hours: 1.5, km: 8, mode: "car", costUsd: 18 },
        ] },
      { day: 6, title: "Jozankei Forest Onsen", base: "Sapporo", stayUsd: 85,
        stops: [
          { place: "Kappa Bus to Jozankei", activity: "Hidden valley onsen retreat", hours: 4, km: 30, mode: "bus", costUsd: 40 },
        ] },
      { day: 7, title: "Departure", base: "CTS", stayUsd: 0,
        stops: [
        ...
        ] },
  {
    ...
    bestMonths: [11, 12, 1, 2],
    difficulty: "moderate",
    terrains: ["desert", "history", "city"],
    blurb: "The Land of Kings. Experience the blue streets of Jodhpur and the romantic lakes of Udaipur.",
    totalUsd: 450,
    highlights: ["Mehrangarh Fort", "Lake Pichola boat ride", "Blue City walk"],
    category: "Classic",
    tags: ["Heritage", "Royal", "Photography"],
    plan: [
      { day: 1, title: "Blue City Arrival", base: "Jodhpur", stayUsd: 60,
        stops: [
          { place: "JDH Airport → Old City", activity: "Check-in at Heritage Haveli", hours: 1, km: 10, mode: "car", costUsd: 15 },
          { place: "Ghanta Ghar", activity: "Saffron Lassi at Clock Tower market", hours: 2, km: 1, mode: "walk", costUsd: 5 },
        ] },
      { day: 2, title: "The Mighty Fortress", base: "Jodhpur", stayUsd: 60,
        stops: [
          { place: "Mehrangarh Fort", activity: "Exploring one of India's largest forts", hours: 3, km: 5, mode: "car", costUsd: 15 },
          { place: "Jaswant Thada", activity: "Marble cenotaph with city views", hours: 1.5, km: 1, mode: "walk", costUsd: 5 },
        ] },
      { day: 3, title: "Drive to the Lake City", base: "Udaipur", stayUsd: 80,
        stops: [
          { place: "Jodhpur → Udaipur", activity: "Stop at Ranakpur Jain Temple", hours: 6, km: 260, mode: "car", costUsd: 75 },
          { place: "Lake Pichola", activity: "Evening lakeside walk", hours: 1.5, km: 2, mode: "walk", costUsd: 0 },
        ] },
      { day: 4, title: "City Palace & Lakes", base: "Udaipur", stayUsd: 80,
        stops: [
          { place: "City Palace", activity: "Royal artifacts & architecture", hours: 3, km: 2, mode: "car", costUsd: 20 },
          { place: "Lake Pichola Boat", activity: "Sunset boat ride past Lake Palace", hours: 1.5, km: 3, mode: "boat", costUsd: 15 },
        ] },
      { day: 5, title: "Departure", base: "Udaipur", stayUsd: 0,
        stops: [
          { place: "UDR Airport", activity: "Final transfer", hours: 1, km: 22, mode: "car", costUsd: 15 },
        ] },
    ],
  },
];
